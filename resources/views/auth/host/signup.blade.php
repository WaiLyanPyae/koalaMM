    ...
    <div
        ...
        <div class="flex h-screen bg-gray-900 bg-opacity-60 backdrop-blur-sm">
            <div class="m-auto bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                <h1 class="text-3xl font-semibold text-center text-gray-800 mb-8">Host Sign Up</h1>

                <form action="{{ route('host.signup') }}" method="POST" class="space-y-6">
                    @error('name')
                ...
                <p class="text-center mt-6 text-sm text-gray-500">
                    Already have an account? <a href="{{ route('host.login') }}"
